...
exports.generate = function (payload, secret, options = {}) {
    ...
    if (payload.iat === undefined &&
        ...
        payload = Object.assign({}, payload);           // Shallow cloned
        payload.iat = internals.tsSecs(options.now);
    }

    const header = Object.assign({ alg: algorithms[0], typ: 'JWT' }, options.header);
    const value = `${Utils.b64stringify(header)}.${Utils.b64stringify(payload, options.encoding || 'utf8')}`;
...
exports.verify = function ({ decoded, raw }, secret, options = {}) {
